...
.profile-sidebar { width: 220px; flex-shrink: 0; background: var(--surface); border-radius: 16px; padding: 14px; border: 1px solid var(--border); display: flex; flex-direction: column; gap: 2px; }
.sidebar-btn { display: flex; align-items: center; gap: 8px; padding: 8px 12px; border-radius: 10px; border: none; background: transparent; cursor: pointer; font-weight: 500; font-size: 0.8rem; color: var(--text-secondary); width: 100%; text-align: left; }
.sidebar-btn:hover, .sidebar-btn.active { background: var(--primary-light); color: var(--primary); }
.profile-main { flex: 1; min-width: 0; }
.card { background: var(--surface); border-radius: 16px; padding: 20px; border: 1px solid var(--border); margin-bottom: 12px; }
.input { width: 100%; padding: 10px; border: 2px solid var(--border); border-radius: 10px; font-family: inherit; font-size: 0.85rem; background: var(--input-bg); color: var(--text); }
.word-card { background: var(--hover); padding: 8px; border-radius: 8px; margin-bottom: 4px; border-left: 3px solid #6366f1; display: flex; justify-content: space-between; align-items: center; font-size: 0.85rem; }
.session { border-left: 4px solid #6366f1; padding: 10px 14px; margin-bottom: 6px; background: var(--hover); border-radius: 0 8px 8px 0; font-size: 0.85rem; }
