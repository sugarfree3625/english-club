...
export type DataBindingImportPolicy = DataBindingImportAction | ((context: DataBindingImportContext) => DataBindingImportAction);
...
export interface TraitEventCallback {
	...
	[TraitsEvents.categoryUpdate]: [
		TraitCategoryUpdateEventData
	];
	[TraitsEvents.custom]: [
		TraitCustomData
	];
...
export type ComponentEventStatic = Exclude<`${ComponentsEvents}`, `${ComponentsEvents.updateProperty}` | `${ComponentsEvents.styleUpdateProperty}`>;
export type SymbolMainEvent = ComponentsEvents.symbolMainAdd | ComponentsEvents.symbolMainUpdate | ComponentsEvents.symbolMainUpdateDeep | ComponentsEvents.symbolMainRemove;
export type SymbolInstanceEvent = ComponentsEvents.symbolInstanceAdd | ComponentsEvents.symbolInstanceRemove;
export type ComponentEvent = ComponentEventStatic | `${ComponentsEvents.updateProperty}${string}` | `${ComponentsEvents.styleUpdateProperty}${string}`;
...
export type ComponentResizeEventData = ({
	...
	type: "move";
} & ComponentResizeEventMoveProps) | ComponentResizeEventEndData;
...
export interface ComponentsEventCallback {
	...
	[ComponentsEvents.remove]: [
		Component
	];
	[ComponentsEvents.removeBefore]: EventCallbackRemoveBefore<Component>;
	[ComponentsEvents.removed]: [
		Component,
		ComponentRemovedEventData | undefined
	];
	[ComponentsEvents.clone]: [
		Component
	];
	[ComponentsEvents.create]: [
		Component,
		ComponentOptions
	];
	[ComponentsEvents.update]: [
		Component,
		...any[]
	];
	[ComponentsEvents.updateInside]: [
		ComponentUpdateEventData
	];
	[ComponentsEvents.styleUpdate]: [
		Component,
		ComponentStyleUpdateEventData
	];
	[ComponentsEvents.select]: [
		Component,
		ObjectAny
	];
	[ComponentsEvents.selectBefore]: [
		Component,
		ObjectAny
	];
	[ComponentsEvents.selected]: [
		Component,
		ObjectAny
	];
	[ComponentsEvents.deselected]: [
		Component,
		ObjectAny
	];
	[ComponentsEvents.toggled]: [
		Component?,
		ObjectAny?
	];
	[ComponentsEvents.hover]: [
		Component | undefined,
		ObjectAny
	];
	[ComponentsEvents.hoverBefore]: [
		Component,
		ObjectAny
	];
	[ComponentsEvents.hovered]: [
		Component,
		ObjectAny
	];
	[ComponentsEvents.unhovered]: [
		Component,
		ObjectAny
	];
	[ComponentsEvents.paste]: [
		Component
	];
	[ComponentsEvents.syncStyle]: [
		ComponentSyncStyleEventData
	];
	[ComponentsEvents.typeAdd]: [
		ComponentTypeEventData
	];
	[ComponentsEvents.typeUpdate]: [
		ComponentTypeEventData
	];
	[ComponentsEvents.dragStart]: [
		ComponentDragEventData
	];
	[ComponentsEvents.drag]: [
		ComponentDragEventData
	];
	[ComponentsEvents.dragEnd]: [
		ComponentDragEventData
	];
	[ComponentsEvents.mount]: [
		Component
	];
	[ComponentsEvents.scriptMount]: [
		ComponentScriptEventData
	];
	[ComponentsEvents.scriptMountBefore]: [
		ComponentScriptEventData
	];
	[ComponentsEvents.scriptUnmount]: [
		ComponentScriptEventData
	];
	[ComponentsEvents.render]: [
		ComponentScriptEventData
	];
	[ComponentsEvents.input]: [
		Component
	];
	[ComponentsEvents.content]: [
		Component | undefined,
		ResetFromStringOptions,
		string
	];
	[ComponentsEvents.resize]: [
		ComponentResizeEventData
	];
	[ComponentsEvents.resizeStart]: [
		ComponentResizeEventStartProps | ComponentResizeEventMoveProps
	];
	[ComponentsEvents.resizeMove]: [
		ComponentResizeEventMoveProps
	];
	[ComponentsEvents.resizeEnd]: [
		ComponentResizeEventEndProps
	];
	[ComponentsEvents.resizeUpdate]: [
		ComponentResizeEventUpdateProps
	];
	[ComponentsEvents.resizeInit]: [
	...
	[ComponentsEvents.symbolMain]: [
		SymbolMainEventData
	];
	[ComponentsEvents.symbolInstanceAdd]: [
		SymbolEventData
	];
	[ComponentsEvents.symbolInstanceRemove]: [
		SymbolEventData
	];
	[ComponentsEvents.symbolInstance]: [
		SymbolInstanceEventData
	];
	[ComponentsEvents.symbol]: [
	];
	[key: `${ComponentsEvents.updateProperty}${string}`]: [
		Component,
		...any[]
	];
	[key: `${ComponentsEvents.styleUpdateProperty}${string}`]: [
		Component,
		ComponentStyleUpdateEventData
	];
}
...
Component> {
	 ...
	 */
	processDef(mdl: Component | ComponentDefinition | ComponentDefinitionDefined): Component | ComponentDefinition | ComponentDefinitionDefined;
	onAdd(model: Component, c?: any, opts?: {
		temporary?: boolean;
	}): void;
	static cloneCssRules(em: EditorModel, cmpsMap?: Record<string, ComponentDefinitionDefined[]>): void;
}
...
export declare class ComponentWithCollectionsState<DataResolverType> extends Component {
	collectionsStateMap: DataCollectionStateMap;
	...
	setDataResolver(dataResolver: DataResolverType | undefined): this;
	getDataResolver(): DataResolverType | undefined;
	get dataResolverProps(): DataResolverType | undefined;
	protected listenToDataSource(): void;
	...
	protected getItemKey(items: DataVariableProps[] | {
		[x: string]: DataVariableProps;
...
export type ResolverCurrentItemType = string | number;
declare class ComponentWrapper extends ComponentWithCollectionsState<DataVariableProps> {
	dataSourceWatcher?: DataResolverListener;
	private _resolverCurrentItem;
	private _isWatchingCollectionStateMap;
	get defaults(): {
		dataResolver: null;
		tagName: string;
		removable: boolean;
	...
	setResolverCurrentItem(value: ResolverCurrentItemType): void;
	getCollectionsState(): {
		collectionId: string;
	} | {
		prevItem: Record<string, any> | undefined;
		nextItem: Record<string, any> | undefined;
		currentItem: Record<string, any> | undefined;
		currentIndex: ResolverCurrentItemType | undefined;
		totalItems: number;
		collectionId: string;
	};
	protected onDataSourceChange(): void;
	protected listenToPropsChange(): void;
	private getCollectionsStateMap;
	__postAdd(): void;
	__postRemove(): void;
...
export interface CanvasEventCallback {
	[CanvasEvents.dragEnter]: [
		DataTransfer | null | undefined,
		NonNullable<DraggableContent["content"]>
	];
	[CanvasEvents.dragOver]: [
		Event
	];
	[CanvasEvents.dragEnd]: [
		Event | undefined
	];
	[CanvasEvents.dragData]: [
		DataTransfer | null | undefined,
		CanvasDragDataResult
	];
	[CanvasEvents.drop]: [
		DataTransfer | null | undefined,
		Component | Component[]
	...
	[CanvasEvents.spotAdd]: [
		CanvasSpotEventProps
	];
	[CanvasEvents.spotUpdate]: [
		CanvasSpotEventProps
	];
	[CanvasEvents.spotRemove]: [
		CanvasSpotEventProps
	];
	[CanvasEvents.coords]: [
	];
	...
	[CanvasEvents.toolsUpdate]: [
		CanvasToolsUpdateEventProps
	];
	[CanvasEvents.moveStart]: [
		Dragger
	];
	[CanvasEvents.move]: [
		Dragger
	];
	[CanvasEvents.moveEnd]: [
		Dragger
	];
	[CanvasEvents.frameLoad]: [
		CanvasFrameEventProps
	];
	[CanvasEvents.frameLoadHead]: [
		CanvasFrameEventProps
	];
	[CanvasEvents.frameLoadBody]: [
		CanvasFrameEventProps
	];
	[CanvasEvents.frameUnload]: [
		{
			frame: Frame;
		}
	];
...
declare abstract class BaseComponentNode extends SortableTreeNode<Component> {
	 ...
	 */
	addChildAt(node: BaseComponentNode, index: number, options?: {
		action: string;
	}): BaseComponentNode;
	/**
	 ...
	 */
	removeChildAt(index: number, options?: {
		temporary: boolean;
	}): void;
	/**
...
declare class CssComposer extends ItemManagerModule<CssComposerConfig & {
	...
	storageKey: string;
	protected _itemCache: Map<string, CssRule>;
	/**
	...
	protected _makeCacheKey(rule: CssRule): string;
	_makeCacheKeyFromProps(ruleProps: CssRuleProperties): string;
	/**
	 * On load callback
	 * @private
	 */
	 ...
	 * @private
	 */
	_findRule(selectors: any, state?: string, width?: string, ruleProps?: Omit<CssRuleProperties, "selectors">): CssRule | null;
	/**
	 ...
	 * });
	 * */
	get(selectors: any, state?: string, width?: string, ruleProps?: Omit<CssRuleProperties, "selectors">): CssRule | null;
	getAll(): CssRules;
	/**
	 ...
	 * @private
	 */
	addCollection(data: string | CssRuleJSON[], opts?: AddCollectionOptions, props?: {}): CssRule[];
	/**
	 ...
	 * });
	 */
	getRule(selectors: any, opts?: RuleOptions): CssRule | null | undefined;
	/**
	 ...
	 */
	getIdRule(name: string, opts?: GetSetRuleOptions): CssRule | null | undefined;
	/**
	 ...
	 */
	getClassRule(name: string, opts?: GetSetRuleOptions): CssRule | null | undefined;
	/**
...
TComp> {
	 ...
	 */
	renderChildren(): void;
	renderAttributes(m?: any, v?: any, opts?: UpdateComponentsOptions): void;
	onAttrUpdate(): void;
	render(): this;
	postRender(): void;
...
export interface LayerEventCallback {
	...
	[LayerEvents.component]: [
		Component,
		ObjectAny?
	];
	[LayerEvents.custom]: [
		LayerCustomEventData
	];
	[LayerEvents.render]: [
		LayerRenderEventData
	];
}
...
export declare class Component extends StyleableModel<ComponentProperties> {
	...
	onCollectionsStateMapUpdate(collectionsStateMap: DataCollectionStateMap): void;
	syncComponentsCollectionState(): void;
	protected stopSyncComponentCollectionState(): void;
	protected syncOnComponentChange(model: Component, collection: Components, opts: any): void;
	__postAdd(opts?: {
		recursive?: boolean;
	}): void;
	__postRemove(): void;
	__onChange(m: any, opts: any): void;
	__onStyleChange(newStyles: StyleProps, opts?: UpdateStyleOptions): void;
	__changesUp(options: any, data?: Record<string, any>): void;
	...
	static createId(model: Component, opts?: CheckIdOptions): string;
	static getNewId(list: ObjectAny): string;
	static getListCount(list: ObjectAny): number;
	static setListId(list: ObjectAny, id: string, model: Component): void;
	...
	static checkId(components: ComponentDefinitionDefined | ComponentDefinitionDefined[], styles?: CssRuleJSON[], list?: ObjectAny, opts?: CheckIdOptions): {
		updatedIds: Record<string, ComponentDefinitionDefined[]>;
	};
}
...
export interface StorageEventCallback {
	...
	[StorageEvents.startStore]: [
		ProjectData
	];
	[StorageEvents.startLoad]: [
		ProjectData | undefined
	];
	[StorageEvents.load]: [
		ProjectData,
	...
	[StorageEvents.afterStore]: [
		ProjectData,
		unknown
	];
	[StorageEvents.afterLoad]: [
		ProjectData,
		unknown
	];
	[StorageEvents.end]: [
	...
	[StorageEvents.endStore]: [
		unknown,
		unknown?
	];
	[StorageEvents.endLoad]: [
		unknown,
		unknown?
	];
	[StorageEvents.error]: [
	...
	[StorageEvents.errorStore]: [
		unknown
	];
	[StorageEvents.errorLoad]: [
		unknown
	];
}
...
export interface AssetsEventCallback {
	...
	[AssetsEvents.uploadEnd]: [
		any
	];
	[AssetsEvents.uploadError]: [
		Error
	];
	[AssetsEvents.uploadResponse]: [
		any
	];
	[AssetsEvents.custom]: [
		AssetsCustomData
...
declare enum RichTextEditorEvents {
	/**
...
export interface RichTextEditorEventCallback {
	[RichTextEditorEvents.enable]: [
		ComponentTextView,
		RichTextEditor
	];
	[RichTextEditorEvents.disable]: [
		ComponentTextView,
		RichTextEditor | undefined
	];
	[RichTextEditorEvents.custom]: [
...
declare class RichTextEditorModule extends Module<RichTextEditorConfig & {
	...
	events: typeof RichTextEditorEvents;
	/**
	 * Get configuration object
	 * @name getConfig
	 * @function
...
declare enum StyleManagerEvents {
	/**
...
export interface StyleManagerEventCallback {
	[StyleManagerEvents.sectorAdd]: [
		Sector,
		AddOptions
	];
	[StyleManagerEvents.sectorRemove]: [
		Sector,
		RemoveOptions
	];
	[StyleManagerEvents.sectorUpdate]: [
		Sector,
		Partial<SectorProperties>,
		ObjectAny
	];
	[StyleManagerEvents.propertyAdd]: [
		Property,
		AddOptions
	];
	[StyleManagerEvents.propertyRemove]: [
		Property,
		RemoveOptions
	];
	[StyleManagerEvents.propertyUpdate]: [
		StyleManagerPropertyUpdateEventData
	];
	[StyleManagerEvents.target]: [
		StyleTarget | undefined
	];
	[StyleManagerEvents.layerSelect]: [
		StyleManagerLayerSelectEventData
	];
	[StyleManagerEvents.custom]: [
		StyleManagerCustomEventData
	];
	[StyleManagerEvents.all]: [
		StyleManagerAllEventData
	];
}
...
Sectors> {
	...
	events: typeof StyleManagerEvents;
	sectors: Sectors;
...
export interface BlocksEventCallback {
	...
	[BlocksEvents.dragEnd]: [
		Component | undefined,
		Block
	];
	[BlocksEvents.categoryUpdate]: [
		{
			category: Category;
			changes: Partial<CategoryProperties>;
			options: AddOptions;
...
export interface SelectorEventCallback {
	...
	[SelectorEvents.state]: [
		SelectorStateEventData,
		SelectorStateEventOptions?
	];
	[SelectorEvents.custom]: [
		SelectorCustomEventData
	];
...
declare const ParserHtml: (em?: EditorModel, config?: ParserConfig & {
	...
	parseAttributeValue(attrValue?: string | boolean): any;
	getPropAttribute(attrName: string, attrValue?: string): {
		name: string;
		value: any;
	};
	shouldConvertAttributeValue(attribute: string, value: string | boolean, node: HTMLElement, convertAttributeValues: HTMLParserOptions["convertAttributeValues"]): boolean;
	/**
	...
	parseNodeAttr(node: HTMLElement, modelResult?: ComponentDefinitionDefined, opts?: HTMLParserOptions): ComponentDefinitionDefined;
...
export interface ParserEventCallback {
	[ParserEvents.htmlBefore]: [
		{
			input: string;
		}
	];
	[ParserEvents.htmlRoot]: [
		{
			input: string;
			root: HTMLElement;
		}
	...
	[ParserEvents.html]: [
		{
			input: string;
			output: HTMLParseResult;
			options: HTMLParserOptions;
		}
	];
	[ParserEvents.cssBefore]: [
		{
			input: string;
		}
	];
	[ParserEvents.css]: [
		{
			input: string;
			output: CssRuleJSON[];
			nodes: Array<CssRuleJSON | ParsedCssRule>;
			error: unknown;
		}
	];
	[ParserEvents.all]: [
...
declare class UtilsModule extends Module {
	...
	helpers: {
		...
		set: (object: ObjectAny, path: string | string[], value: any) => boolean;
...
/**{END_EVENTS}*/
export type KeymapEvent = `${KeymapsEvents.add}` | `${KeymapsEvents.remove}` | `${KeymapsEvents.emit}` | `${KeymapsEvents.emitId}${string}`;
export interface KeymapsEventCallback {
	...
	[key: `${KeymapsEvents.emitId}${string}`]: [
		Keymap["id"],
		string,
		Event
	];
...
export type CommandEvent = `${CommandsEvents.run}` | `${CommandsEvents.stop}` | `${CommandsEvents.call}` | `${CommandsEvents.runCommand}${string}` | `${CommandsEvents.runBeforeCommand}${string}` | `${CommandsEvents.abort}${string}` | `${CommandsEvents.stopCommand}${string}` | `${CommandsEvents.stopBeforeCommand}${string}` | `${CommandsEvents.callCommand}${string}`;
export interface CommandsEventCallback {
	...
	[CommandsEvents.call]: [
		CommandCallEventData
	];
	[key: `${CommandsEvents.runCommand}${string}`]: [
		CommandEventData | CommandEventBeforeData
	];
	[key: `${CommandsEvents.abort}${string}`]: [
		CommandEventBeforeData
	];
	[key: `${CommandsEvents.stopCommand}${string}`]: [
		CommandEventData | CommandEventBeforeData
	];
	[key: `${CommandsEvents.callCommand}${string}`]: [
		CommandCallEventData
	];
}
...
export declare class DataSourceManager extends ItemManagerModule<DataSourcesConfig & ModuleConfig, DataSources> {
	storageKey: string;
	events: typeof DataSourcesEvents;
	dataComponentTypes: typeof DataComponentTypes;
	dataCollectionKeys: typeof DataCollectionKeys;
	dataCollectionStateTypes: typeof DataCollectionStateType;
	dataFieldPrimitiveType: typeof DataFieldPrimitiveType;
	dataOperationTypes: {
		any: typeof AnyTypeOperation;
		boolean: typeof BooleanOperation;
		number: typeof NumberOperation;
		string: typeof StringOperation;
	};
	destroy(): void;
	constructor(em: EditorModel);
	/**
	 ...
	 * const ds = dsm.getAll();
	 */
	getAll(): DataSource<DataRecordProps>[];
	/**
	 ...
	 */
	getValue(path: string | string[], defValue?: any, opts?: {
	 ...
	 */
	store(): {
		[x: string]: DataSourceProps<DataRecordProps>[];
	};
	/**
...
export type EditorLogEvent = `${EditorEvents.log}:${string}` | `${EditorEvents.log}-${string}` | `${EditorEvents.log}-${string}:${string}`;
export type EditorCoreEvent = `${EditorEvents}` | EditorLogEvent | "canvasScroll";
export type EditorBuiltInEvents = EditorCoreEvent | DataSourceEvent | DeviceEvent | I18nEvent | ComponentEvent | BlockEvent | AssetEvent | KeymapEvent | LayerEvent | PageEvent | ParserEvent | StyleManagerEvent | StorageEvent | CanvasEvent | SelectorEvent | RichTextEditorEvent | TraitEvent | ModalEvent | CommandEvent;
...
export interface EditorEventCoreCallbacks {
	...
	[EditorEvents.projectLoad]: [
		EditorProjectLoadEventData
	];
	[EditorEvents.projectLoaded]: [
		EditorProjectEventData
	];
	[EditorEvents.projectGet]: [
		EditorProjectGetEventData
	];
	[EditorEvents.log]: [
		string,
		EditorLogEventOptions
	];
...
declare class EditorModel extends Model {
	...
	on<E extends EditorEvent>(event: E, callback: EditorEventHandler<E>, context?: any): this;
	once<E extends EditorEvent>(event: E, callback: EditorEventHandler<E>, context?: any): this;
	off<E extends EditorEvent>(event?: E, callback?: EditorEventHandler<E>, context?: any): this;
	trigger<E extends EditorEvent>(event: E, ...args: E extends keyof EditorEventCallbacks ? EditorEventCallbacks[E] : any[]): this;
	constructor(conf?: EditorConfig);
	_checkReady(): void;
	getContainer(): HTMLElement | undefined;
	listenLog(event: keyof typeof logs): void;
	 ...
	 * @private
	 * */
	handleUpdates(opt: any, data: Record<string, any>): void;
	changesUp(opts: any, data: Record<string, any>): void;
	/**
...
declare class ModelDataResolverWatchers<T extends StyleableModelProperties> {
	...
	shouldResolveProps(props: ObjectAny): boolean;
	...
	private hasDataValues;
	private hasResolverValue;
	private isComponent;
...
export declare class CssRule extends StyleableModel<CssRuleProperties> {
	...
	__onChange(rule: CssRule, options: any): void;
	clone(): typeof this;
	 ...
	 */
	getAtRule(): string;
	static getAtRuleFromProps(cssRuleProps: Partial<CssRuleProperties>): string;
	/**
...
export type ConvertAttributeValuesOption = boolean | readonly string[] | ((props: {
	attribute: string;
...
export type EventCallbackAdd<M> = [
	M,
	AddOptions
];
export type EventCallbackUpdate<M> = [
	M,
	AddOptions
];
export type EventCallbackRemove<M> = [
	M,
	RemoveOptions
];
export type EventCallbackRemoveBefore<M> = [
	M,
	RemoveFn: () => void,
	RemoveOptions
];
export type EventCallbackAll<E, M> = [
	{
		event: E;
		model?: M;
		options: ObjectAny;
...
declare abstract class ItemManagerModule<TConf extends ModuleConfig = ModuleConfig, TCollection extends Collection = Collection> extends Module<TConf> {
	...
	protected _itemCache: Map<string, Model<any, SetOptions, any>>;
	...
	protected _makeCacheKey(m: Model): string;
	protected _cacheItem(item: Model): void;
	protected _uncacheItem(item: Model): void;
	protected _clearItemCache(): void;
	protected _onItemsResetCache(collection: Collection): void;
	protected _onItemKeyChange(item: Model): void;
	protected _setupCacheListeners(): void;
...
export declare abstract class ComponentWithDataResolver<T extends DataResolverProps> extends Component {
...
export declare class ComponentDataCollection extends ComponentWithCollectionsState<DataCollectionProps> {
	dataSourceWatcher?: DataResolverListener;
	get defaults(): ComponentDefinitionDefined;
	...
	onCollectionsStateMapUpdate(collectionsStateMap: DataCollectionStateMap): void;
	protected stopSyncComponentCollectionState(): void;
	protected setCollectionStateMapAndPropagate(cmp: Component, collectionsStateMap: DataCollectionStateMap): void;
	protected onDataSourceChange(): void;
	protected listenToPropsChange(): void;
	protected get dataSourceProps(): DataVariableProps | undefined;
